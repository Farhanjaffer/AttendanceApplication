...
class DatabaseHelper {
  ...
  String noteTable =
      "CREATE TABLE notes (noteId INTEGER PRIMARY KEY AUTOINCREMENT,Name INTEGER NOT NULL, noteTitle TEXT NOT NULL, noteContent TEXT NOT NULL, createdAt TEXT DEFAULT CURRENT_TIMESTAMP)";
  ...
  //Search Method
  Future<List<NoteModel>> searchNotes(String keyword, Users user) async {
    final Database db = await initDB();
    List<Map<String, Object?>> searchResult = await db
        .rawQuery("select * from notes where noteTitle LIKE ? and name = '${user.usrName}'");
